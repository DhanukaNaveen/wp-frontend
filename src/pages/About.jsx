    ...
    <div className="w-full px-4 md:px-8 py-5 md:py-16 bg-white text-gray-800 mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        ...
        <section className="p-6 bg-gray-50 rounded-lg shadow-inner">
          <h3 className="text-2xl font-bold mb-4 border-b pb-2 text-black">⚙️ My Essential Gear</h3>
          <ul className="list-inside text-gray-700 space-y-3 text-xl">
            <li className="flex items-center gap-2">📸 <span className="font-semibold">Primary Camera:</span> Canon EOS R6 with RF 24-70mm f/2.8</li>
            <li className="flex items-center gap-2">🌍 <span className="font-semibold">Travel/Street:</span> Fujifilm X-T5 for mobility</li>
            <li className="flex items-center gap-2">💡 <span className="font-semibold">Lighting:</span> Godox AD200 Pro and natural reflectors</li>
            <li className="flex items-center gap-2">💻 <span className="font-semibold">Post-Processing:</span> Adobe Lightroom & Capture One</li>
          </ul>
        </section>
        ...
        <section className="p-6 bg-gray-50 rounded-lg shadow-inner">
          ...
          <ul className="list-inside text-gray-700 space-y-3 text-xl">
            <li className="flex items-center gap-2">✨ Featured in Vogue Sri Lanka (2024)</li>
            <li className="flex items-center gap-2">💍 Wedding shoots for 50+ couples across Asia</li>
            <li className="flex items-center gap-2">👗 Collaborations with local fashion brands</li>
            <li className="flex items-center gap-2">🖼️ Exhibited at Colombo Art Week</li>
          </ul>
        </section>
      </div>
